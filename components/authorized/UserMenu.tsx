...
export default function UserMenu({ isMenuActive, setIsSettingsMenuActive, setMenuActive, menuRef }: UserMenuProps) {
    ...
    return (
        <DropDownMenu
            ...
            menuRef={menuRef}
            className="absolute right-1/2 translate-x-1/2  sm:translate-x-0 -bottom-3 translate-y-[100%] sm:right-0 shadow-lg rounded-lg flex flex-col gap-4 bg-white py-6 px-4 z-10 text-center sm:text-left"
        >
