...
export default function UserMenu({ isMenuActive, setIsSettingsMenuActive, setMenuActive, triggerRef }: UserMenuProps) {
  ...
  return (
    <DropDownMenu
      ...
      className="absolute right-1/2 translate-x-1/2 md:translate-x-0 -bottom-3 translate-y-[100%] md:right-0 shadow-lg rounded-lg flex flex-col gap-2 bg-white pt-5 py-3.5 md:py-6 w-[80vw] md:w-auto md:px-4 text-center md:text-left"
    >
