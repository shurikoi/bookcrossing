...
export default function CrossBtn({ setMenuActive, smallScreen }: CrossBtnProps) {
    return (
        <div
            className={`${smallScreen ? "right-4 top-4 w-4 h-4" : "right-0 top-0 translate-x-[calc(100%+10px)] w-8 h-8"} absolute rounded-full cursor-pointer`}
            onClick={() => setMenuActive(false)}
        >
            <svg width="36" height="36" viewBox="0 0 36 36" stroke="black" xmlns="http://www.w3.org/2000/svg">
                <path
