...
export default function BookMenuLoader() {
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-10">
            <div className="flex flex-col gap-10 shrink-0 lg:w-[220px]">
            ...
            <div className="flex flex-col gap-8 items-center text-center lg:items-start lg:text-left px-6 lg:p-0">
                ...
                <div className="w-full grid grid-cols-[repeat(2,1fr)] grid-rows-2 font-extralight leading-none text-[14px] gap-y-6 gap-x-10 lg:pr-10">
                    <div className="flex flex-col gap-3 whitespace-nowrap items-center lg:items-start">
                ...
                <div className="text-[#474747] font-light font-inter mt-auto text-[15px] w-full lg:w-[500px] h-[180px] skeleton"></div>
                {isSmallScreen && (
                    <div className="flex flex-col gap-2.5 w-full">
                        <div className="py-2 skeleton rounded-lg cursor-pointer h-[2.75rem]"></div>
                        <div className="py-2 skeleton rounded-lg cursor-pointer h-[2.75rem]"></div>
