...
export default function GetStarted() {
    return (
        <div className="flex flex-col items-center gap-[110px] px-[70px] 2md:px-[230px] py-[75px] font-medium text-[20px]">
            <div className="text-center text-[25px]">Zobacz jak zacząć</div>
