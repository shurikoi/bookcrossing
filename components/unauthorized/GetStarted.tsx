...
export default function GetStarted({ setIsFormActive }: { setIsFormActive: Dispatch<SetStateAction<boolean>> }) {
  return (
    <div className="flex flex-col items-center gap-[70px] px-[70px] lg:px-[230px] py-[75px] font-normal text-[20px]">
      <div className="text-center text-[25px] font-normal">Zobacz jak zacząć</div>

      <div className="inline-grid grid-cols-1 lg:text-left text-center">
      ...
      <GetStartedBtn setIsFormActive={setIsFormActive}></GetStartedBtn>
    </div>
  );
}
