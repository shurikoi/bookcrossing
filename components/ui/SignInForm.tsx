...
export default function signInForm() {
    ...
    return (
        <form
            ref={formRef}
            className={`fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] flex flex-col gap-9 max-w-[460px] px-14 py-10 bg-white shadow-sm text-center duration-300 rounded-lg ${
