...
export default function AuthForm({ isFormActive, setIsFormActive }: AuthFormProps) {
  ...
  return (
    <ModalMenu isModalActive={isFormActive} setIsModalActive={setIsFormActive}>
      <form className="flex items-center flex-col gap-4 w-full md:max-w-[500px] text-center px-6 py-8 sm:p-10" onKeyDown={handleKeyDown}>
        ...
        <div className="flex flex-col gap-3">
          <input
            ...
            name="login"
            placeholder="Login"
            className="placeholder:font-light relative border-[#61C558] border rounded-lg px-4 py-2.5 text-[15px] flex justify-between duration-300 w-full md:w-auto gap-3"
            value={login}
            onChange={(e) => {
